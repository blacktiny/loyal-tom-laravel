                ...
                <div class="col-md-12">
                    <div class="portlet light bordered form-fit">
                        ...
                        <div class="portlet-body form">
                            ...
                            @endif
                            {!! Form::open(['route' => 'ca.interests', 'method'=>'post', 'class'=>'form-horizontal form-bordered form-label-stripped', 'id' => 'form-client']) !!}
                            ...
                            <div class="form-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label col-md-3">Which region/canton she or he is located?</label>
                                    <div class="col-md-9">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-9">
                                        <input type="number" name="dataWeek" id="calendar" readonly >
                                    </div>
                                </div>
                                <div class="form-group">
