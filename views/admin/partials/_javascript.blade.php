...
<script src="{{ asset('css/global/scripts/datatable.js')}}" type="text/javascript"></script>
<script src="{{ asset('css/global/plugins/datatables/jquery.dataTables.min.js')}}" type="text/javascript"></script>
...
<script src="{{ asset('css/layout2/global/scripts/quick-sidebar.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('css/pages/scripts/table-datatables-managed.min.js')}}" type="text/javascript"></script>
<script src="{{ asset('css/pages/scripts/table-datatables-editable.js')}}" type="text/javascript"></script>
