...
@section('content')
    ...
    <div class="page-content">
        <h1 class="page-title"> Create New Idea<small> </small></h1>
        <!-- BREADCRUMBS-->
        <div class="page-bar">
        ...
        {!! Form::open(['route' => 'ideas.store', 'method'=>'POST', 'files' => 'true', 'id'=>'fileupload']) !!}
        <div class="row">
            <div class="col-md-6">
                    ...
                    <div class="portlet-body form">
                        <div class="form-body">
                            ...
                            <div class="form-group {{ $errors->has('headline') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="headline" value="{{ old('headline') }}" required>
                            ...
                            <div class="form-inline {{ $errors->has('price') ? ' has-error' : '' }}">
                                <input type="text" class="form-control" name="price" value="{{ old('price') }}" placeholder="150.00" pattern="\d+(\.\d{2})?" required>
                            ...
                            <label for="additional_price">Additional Price <small>(CHF)</small>*: </label>
                            <div class="form-inline {{ $errors->has('additional_price') ? ' has-error' : '' }}">
                                <input type="number" class="form-control" name="additional_price" value="{{ old('additional_price')?old('additional_price'):'50' }}" placeholder="50.00" pattern="\d+(\.\d{2})?" min="1" required>
                            ...
                            <div class="form-group {{ $errors->has('button_buy_text') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="button_buy_text" value="{{ old('button_buy_text') }}" required>
                            ...
                            <div class="form-group {{ $errors->has('button_buy_for_me_text') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="button_buy_for_me_text" value="{{ old('button_buy_for_me_text') }}" required>
                    ...
                    <div class="portlet-body form">
                        <div class="form-body">
                            ...
                            <div class="form-group {{ $errors->has('video') ? ' has-error' : '' }}">
                                ...
                                <input type="text" class="form-control" name="video" value="{{ old('video') }}" placeholder="https://www.youtube.com/embed/dsJtgmAhFF4">
                                @if ($errors->has('video'))
                                    <span class="help-block">
    ...
    <script type="text/javascript">
        ...
        $('#add-new-field').on('click', function(e){
            ...
            $('#new-dates').append('' +
                ...
                '<input type="text" name="daterange['+i+']" class="daterange form-control" />');
            i++;
            //DateRangePicker
            $('.daterange').daterangepicker({
                locale: {
